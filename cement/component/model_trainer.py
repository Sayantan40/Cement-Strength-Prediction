...
from cement.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
from cement.entity.config_entity import ModelTrainerConfig
from cement.util.util import load_numpy_array_data,save_object,load_object
from cement.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from cement.entity.model_factory import evaluate_regression_model



class CementEstimatorModel:
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)-> ModelTrainerArtifact:
        ...
        try:
            ...
            cement_model = CementEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
            
            logging.info(f"Saving model at path: {trained_model_file_path}")
            
            save_object(file_path=trained_model_file_path,obj=cement_model)
